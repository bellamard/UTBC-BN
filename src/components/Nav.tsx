            ...
            <div className="container mx-auto">
                <div className='w-3/4 bg-black/20 h-[60px] backdrop-blur-2-xl rounded-full max-w-[460] mx-auto px-5 flex justify-between items-center text-2xl text-red/50'>
                    <Link
                        ...
                        smooth={true}
                        spy={true}
                        className='mx-2 cursor-pointer h-[60px] flex items-center justify-center flex flex-col text-xs text-white'>
                    ...
                    <Link
                        ...
                        smooth={true}
                        spy={true}
                        className='cursor-pointer h-[60px] flex items-center justify-center flex flex-col text-xs text-white'>
